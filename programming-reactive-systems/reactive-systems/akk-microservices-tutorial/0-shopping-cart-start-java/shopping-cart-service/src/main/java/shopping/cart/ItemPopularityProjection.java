...
public class ItemPopularityProjection {
    ...
    public static void init(ActorSystem<?> system, JpaTransactionManager jpaTransactionManager,
                ...
                .init(
                        ...
                        index ->
                                ProjectionBehavior.create(
                                        createProjectionFor(system, jpaTransactionManager, itemPopularityRepository, index)),
