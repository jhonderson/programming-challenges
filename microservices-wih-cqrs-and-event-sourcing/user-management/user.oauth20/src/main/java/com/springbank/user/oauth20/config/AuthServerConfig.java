...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Override
    public void configure(AuthorizationServerEndpointsConfigurer endpoinds) {
        endpoinds.authenticationManager(authenticationManager)
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                ...
                .accessTokenValiditySeconds(tokenValiditySecs)
                .refreshTokenValiditySeconds(refreshTokenValiditySecs);
    }
}
